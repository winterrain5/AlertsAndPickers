...
class ViewController: UIViewController {
    ...
    fileprivate lazy var segments: SegmentedControl = SegmentedControl()
    ...
    override func viewDidLoad() {
        ...
        segments.segmentTitles = styles
        segments.action { [weak self] index in
        ...
        segments.tintColor = UIColor(hex: 0xFF2DC6)//UIColor(hex: 0x3C3C3C)
    ...
    func show(alert type: AlertType) {
        ...
        case .twoTextFields:
            ...
            let textFieldOne: TextField.Config = { textField in
                textField.left(image: UIImage.init(named: "user"), color: UIColor(hex: 0x007AFF))
